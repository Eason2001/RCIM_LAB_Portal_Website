					...
					<section class="latest-news clear">
						<div class="ed-container-home">
							...
							if(get_theme_mod('eightmedi_lite_news_button_option')=='enable' && $btn_text!=""){
								...
								?> 
								<div class="btn-wrapper wow FadeInUp" data-wow-delay="0.5s"><a href="<?php echo esc_url($wl_news_cat_url); ?>" class="btn"><?php echo esc_attr(get_theme_mod('eightmedi_lite_news_button_text',__('View All','eightmedi-lite'))); ?></a>
								</div> 
								<?php } ?>
								<?php
